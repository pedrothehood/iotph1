...
Die Tabellen Sensor und die tabellen Sensorid werden eingelesen(Beachte, der erste Buchstabe ist Gross geschrieben),
für beide Tabellen gilt: falls variable ”sensor_id” (mit get einlesen) vorhanden ist, dann
im select nach sensorid = sensor_id suchen
select auf tabelle Sensor und tabelle Sensorid mit variable sensor_id, falls sensor_id vorhanden
